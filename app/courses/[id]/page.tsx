...
export default async function CoursePage({ params }: CoursePageProps) {
  ...
  return (
    <article className="max-w-[900px]">
      ...
      <p className="mt-[30px] max-w-[720px] text-[1.06rem] leading-[1.75] text-[#627078]">
        {course.description}
      </p>

      <div className="mt-10 flex flex-wrap items-center justify-start gap-3">
        <div className="inline-flex min-h-12 items-center gap-[9px] rounded-full border border-[#d8d1c5] bg-[#fffdf8] px-[18px]">
