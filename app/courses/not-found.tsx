...
export default function CourseNotFound() {
  return (
    <section className="max-w-[680px] pt-[8vh]">
      ...
      <p className="mt-6 text-[1.1rem] leading-[1.65] text-[#627078] dark:text-slate-300">
        The course may have moved, or the address may be incorrect. Return to
        the catalog to choose another subject.
      </p>
      <Link
        className="mt-[34px] inline-flex items-center gap-3 font-[750] text-[#b94328] focus-visible:rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#b94328] dark:text-orange-400"
        href="/courses"
      >
        ← Back to courses
      </Link>
